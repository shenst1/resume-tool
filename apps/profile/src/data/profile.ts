...
export type ProjectVisual = "fintech-payments";
...
export type Project = {
  ...
  /** Custom illustrated card art instead of a screenshot. */
  ...
  projects: [
    {
      ...
      years: "2023 — Present",
      tags: ["Next.js", "AI / RAG", "MCP", "TypeScript", "Monorepo"],
      image: {
