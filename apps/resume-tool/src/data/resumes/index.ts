...
import { apartmentiqDataInfrastructureResume } from "./apartmentiq-data-infrastructure";
...
import { babylistSeniorSoftwareEngineerResume } from "./babylist-senior-software-engineer";
...
import { docusignSeniorFrontEndResume } from "./docusign-senior-front-end";
...
import { ezcaterSeniorFinanceTechResume } from "./ezcater-senior-finance-tech";
import { engineSeniorFrontendResume } from "./engine-senior-frontend";
import { finiteStateResume } from "./finite-state";
import { flexFrontendEngineerResume } from "./flex-frontend-engineer";
import { foodsmartStaffBackendResume } from "./foodsmart-staff-backend";
import { givecampusSeniorEngineerResume } from "./givecampus-senior-engineer";
...
import { kinSeniorSoftwareEngineerResume } from "./kin-senior-software-engineer";
import { layloSeniorFullstackResume } from "./laylo-senior-fullstack";
import { ltkCreatorFullstackResume } from "./ltk-creator-fullstack";
...
import { reactNodeFullstackContractResume } from "./react-node-fullstack-contract";
import { rentanaResume } from "./rentana";
import { renewedVisionResume } from "./renewed-vision";
import { rezdySeniorStaffSoftwareEngineerResume } from "./rezdy-senior-staff-software-engineer";
...
import { rocketMoneyCoreSeniorFullstackResume } from "./rocket-money-core-senior-fullstack";
...
export const resumes: Record<string, Resume> = {
  ...
  "apartmentiq-data-infrastructure": apartmentiqDataInfrastructureResume,
  alteryx: alteryxResume,
  assured: assuredResume,
  "attentive-identity": attentiveIdentityResume,
  "babylist-senior-software-engineer": babylistSeniorSoftwareEngineerResume,
  bestow: bestowResume,
  ...
  "kin-senior-software-engineer": kinSeniorSoftwareEngineerResume,
  "laylo-senior-fullstack": layloSeniorFullstackResume,
  "ltk-creator-fullstack": ltkCreatorFullstackResume,
  ...
  ramp: rampResume,
  "react-node-fullstack-contract": reactNodeFullstackContractResume,
  rentana: rentanaResume,
  "renewed-vision": renewedVisionResume,
  "rezdy-senior-staff-software-engineer": rezdySeniorStaffSoftwareEngineerResume,
  reflow: reflowResume,
  "regimenpro-senior-fullstack": regimenproSeniorFullstackResume,
  rithum: rithumResume,
  "rocket-money-core-senior-fullstack": rocketMoneyCoreSeniorFullstackResume,
  ...
  "team-one-manager-experience-engineering":
    teamOneManagerExperienceEngineeringResume,
  tenna: tennaResume,
